...
type hubConnection interface {
	...
	SendInvocation(target string, args ...interface{}) (invocationMessage, error)
...
func (c *defaultHubConnection) SendInvocation(target string, args ...interface{}) (invocationMessage, error) {
